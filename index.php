        ...
        <footer class="bg-light py-5">
            <div class="container">
                ...
                <div class="row">
                   ...
                   <p>email</p>
                   <p>maizaz227@gmail.com</p>
                   <p>naeemhaseeb23@gmail.com</p>
                    </div>
                </div>
            </div>
            <br>
            <div class="container"><div class="small text-center text-muted">Copyright © 2024 - <?php echo $_SESSION['setting_name'] ?> | <a href="" target="_blank">Muhmmad Aizaz & Haseeb Naeem </a></div></div>
        </footer>
